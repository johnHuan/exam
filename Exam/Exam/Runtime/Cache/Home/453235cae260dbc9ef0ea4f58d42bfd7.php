...
<div class="jumbotron">
    ...
    <p>
        <a class="btn btn-info btn-sm" href="/Exam/Home/User/ejudgement" role="button">查看判断题</a>
        <a class="btn btn-info btn-sm" href="/Exam/Home/User/eselection" role="button">查看选择题</a>
    </p>
</div>
<!--footer-->
