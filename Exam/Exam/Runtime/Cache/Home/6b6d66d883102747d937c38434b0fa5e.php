...
<div class="jumbotron">
    ...
    <p>目前为止您的练习情况如下： </p>
    <p><span>判断题： 第<?php echo ($user["p_jid"]); ?>题</span></p>
    <p><span>选择题： 第<?php echo ($user["p_sid"]); ?>题</span></p>

    <p>根据规定您必须参加至少1遍练习才可以参与考试</p>
    <p>
        <a class="btn btn-info btn-sm" href="/Exam/Home/Exercise/judgement" role="button">练习判断题</a>
        <a class="btn btn-info btn-sm" href="/Exam/Home/Exercise/selection" role="button">练习选择题</a>
    </p>
</div>
<!--footer-->
