        ...
        <ul class="nav navbar-nav">
            ...
            <li>
                <a href="#" data-toggle="dropdown">
                    ...
                    <span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="/Exam/Home/Index/comment">我有话说</a></li>
                    <li><a href="/Exam/Home/Index/index">通知通告</a></li>
                </ul>
            </li>
            <li>
                <a href="#" data-toggle="dropdown">
                    <span class="glyphicon glyphicon-user"></span> 在线互动
                    <span class="caret"></span></a>
                <ul class="dropdown-menu">
                    <li><a href="/Exam/Home/Index/comment">收藏夹</a></li>
                    <li><a href="/Exam/Home/Index/index">错题本</a></li>
                    <li><a href="/Exam/Home/Index/index">个人资料</a></li>
                </ul>
            </li>
...
<div class="panel panel-default">
    ...
    <form action="/Exam/Home/Index/comment" method="post" class="panel-body">
