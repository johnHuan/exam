    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title"><?php echo ($id); ?>/<?php echo ($total); ?>. <?php echo ($question["question"]); ?>--<?php echo ($question["answer"]); ?>--
                <span class="tid"><?php echo ($question["sid"]); ?></span>
            </h3>
        </div>
...
<script>
    ...
    $("button[name='answer']").on('click', function (e) {
        ...
        $.ajax({
            ...
            url: '/Exam/Home/Exercise/selection',
            ...
            success: function (res) {
                if (res['isRight'] == true && res["end"] == false){
                    ...
                    setTimeout(function () {
                        window.location.href = "/Exam/Home/Exercise/selection?id=<?php echo ($id+1); ?>";
                    }, 500);
    ...
    $("button[name='fav']").on('click', function (e) {
        ...
        $.ajax({
            ...
            url: '/Exam/Home/Exercise/addFavS',
            error: function (e) {
