...
<div class="jumbotron">
    ...
    <p>目前为止您的收藏夹情况如下： </p>
    <p><span>判断题： 共<?php echo ($user["p_jid"]); ?>题</span></p>
    <p><span>选择题： 共<?php echo ($user["p_sid"]); ?>题</span></p>
    <p>
        <a class="btn btn-info btn-sm" href="/Exam/Home/Index/judgement" role="button">查看判断题</a>
        <a class="btn btn-info btn-sm" href="/Exam/Home/Index/selection" role="button">查看选择题</a>
    </p>
</div>
<!--footer-->
